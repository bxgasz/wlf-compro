         ...
         <div class="grid grid-cols-1 lg:grid-cols-2 w-full h-full">
            ...
            <div class="p-10 space-y-5">
               <div class="flex justify-between items-center">
                  <Link :href="route('home')" class="text-sm flex items-center gap-2 text-gray-600 hover:text-gray-900">
                     <span>&larr;</span> <span>Back to home</span>
                  </Link>
               </div>
               <h1 class="text-2xl font-bold">Welcome,<br>our dearest grantee</h1>
               <div>
                  <label
                     for="email"
               ...
               <div>
                  <button
                     @click="handleSubmit"
                     type="submit"
                     class="flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-white transition rounded-lg bg-[#E75E00] shadow-theme-xs"
                  >
                     Login
                  </button>
               </div>
...
const handleSubmit = async () => {
   ...
   form.post(route('auth.login-grantee'), {
         onFinish: () => {
            form.reset('password');
         },
   });
