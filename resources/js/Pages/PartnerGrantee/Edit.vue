...
const form = useForm({
   ...
   'logo': null,
   'description_en': props.partner.description.en,
   'description_id': props.partner.description.id,
})
...
const logo_preview = ref(props.partner.logo ?? null)
      ...
      <ComponentCard title="Update Grantee">
         ...
         <div class="space-y-6">
            ...
            <div class="">
               ...
               Logo (Logo) <span class="text-error-500">*</span></label>
               <div as="button" @click="openFileLogo" class="cursor-pointer p-12 flex justify-center border border-dashed border-gray-300 rounded-xl" data-hs-file-upload-trigger="">
                  ...
                  <img v-else :src="logo_preview" alt="preview">
               </div>
               <label
                     class="block text-sm font-medium text-error-500"
                  >
               ...
               <input class="hidden" type="file" ref="logoInput" name="file" accept="logo/*" @input="handleUploadLogo" />
            </div>
