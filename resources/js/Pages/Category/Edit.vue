...
const form = useForm({
   title_en: props.category.title.en,
   desc_en: props.category.description.en,
   title_id: props.category.title.id,
   desc_id: props.category.description.id,
   image: null
})

const image_preview = ref(props.category.image ?? null)
...
const handleSubmit = async() => {
   ...
   form.post(route('category.update-data', props.category.id), {
      preserveScroll: true,
      onSuccess: () => {
