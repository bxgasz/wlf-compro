...
const handleSubmit = async() => {
   ...
   form.post(route('static-page.store'), {
      preserveScroll: true,
      onSuccess: () => {
...
<template>
   <AdminLayout>
      ...
      <PageBreadcrumb :page-list="[
         { label: 'Static Pages Management', href: 'static-page.index', currPage: false },
         { label: 'Create Static Pages', href: '', currPage: true }
      ]"/>
      <ComponentCard title="Create Static Pages">
