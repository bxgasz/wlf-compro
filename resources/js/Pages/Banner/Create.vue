...
const handleSubmit = () => {
   ...
   form.post(route('banner.store'), {
      ...
      onSuccess: () => {
         ...
         router.visit(route('banner.index'))
      },
      onError: (error) => {
...
<template>
   <AdminLayout>
      <PageBreadcrumb :page-list="[
         ...
         { label: 'Create Banner', href: '', currPage: true }
      ]"/>
      <ComponentCard title="Create Banner">
         ...
         <div class="space-y-6">
            ...
            <div as="button" @click="openFile" class="cursor-pointer p-12 flex justify-center border border-dashed border-gray-300 rounded-xl" data-hs-file-upload-trigger="">
               ...
               <video v-else-if="isVideo && media_preview" controls>
