...
<template>
   <AdminLayout>
      <PageBreadcrumb :page-list="[
         { label: 'Location Management', href: 'location.index', currPage: false },
         { label: 'Create Location', href: '', currPage: true }
      ]"/>
      <ComponentCard title="Create Location">
         ...
         <div class="relative w-full">
            <img src="/assets/img/home/map-new.png" alt="location location" class="w-full brightness-[0.3]" @click="addLocation">
