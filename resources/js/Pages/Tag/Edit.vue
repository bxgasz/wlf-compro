...
const form = useForm({
   title_en: props.tag.title.en,
   desc_en: props.tag.description.en,
   title_id: props.tag.title.id,
   desc_id: props.tag.description.id,
})
...
<template>
   <AdminLayout>
      <PageBreadcrumb :page-list="[
         { label: 'Tag Management', href: 'tag.index', currPage: false },
         { label: 'Create Tag', href: '', currPage: true }
      ]"/>
      <ComponentCard title="Create Tag">
