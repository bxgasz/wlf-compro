...
const form = useForm({
   title_en: props.management.title.en,
   title_id: props.management.title.id,
   desc_en: props.management.description.en,
   desc_id: props.management.description.id,
   position_en: props.management.position?.en,
   position_id: props.management.position?.id,
   image: null,
   link_ig: props.management.link_ig,
   link_fb: props.management.link_fb,
   link_linkedin: props.management.link_linkedin,
})
...
const image_preview = ref(props.management.image)
...
const handleSubmit = () => {
   ...
   form.post(route('management.update', props.management.id))
}
...
<template>
   <AdminLayout>
      <PageBreadcrumb :page-list="[
         ...
         { label: 'Update Management', href: '', currPage: true }
      ]"/>
      <ComponentCard title="Update Management">
